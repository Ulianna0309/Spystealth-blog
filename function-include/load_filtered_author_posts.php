...
function load_filter_author_posts() {
    ...
    $query = new WP_Query($filteredArgs);
    ...
    if( $query->have_posts() ):
        while($query->have_posts()): $query->the_post();
            ...
            ?>
            <article class="author-article post-card-animation">
                <?php
                ...
                <div class="author-article__content">
                    <a href="<?= $category_link; ?>" class="category-label category-label--<?= $post_category[0]->slug; ?>">
                        <?= $post_category[0]->name; ?>
                    </a>
                    <a href="<?php the_permalink(); ?>" class="author-article__title">
                        <?php the_title(); ?>
                    </a>
                    <div class="author-article__text">
                        <?php the_excerpt(); ?>
                    </div>
                    <div class="author-article__footer">
                        <div class="author-article__date">
                            <?php the_time('M j, Y'); ?>
                        </div>
                        <div class="author-article__view">
                        ...
                        <a href="<?php the_permalink(); ?>#comments" class="author-article__comments">
...
add_action('wp_ajax_load-filter-author-posts', 'load_filter_author_posts');
add_action('wp_ajax_nopriv_load-filter-author-posts', 'load_filter_author_posts');
