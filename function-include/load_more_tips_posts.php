...
function load_more_tips_posts() {
    ...
    if( $query->have_posts() ):
        while($query->have_posts()): $query->the_post();
            if ($count == 2 || $count == 4 || $count == 5 || $count == 7 || $count == 9 || $count == 10) {
            ...
            <article class="article post-card-animation article-tips<?= $article_class; ?>">
                ...
                <div class="article__content<?= $article_content_class; ?>">
                    <div class="article__header">
                        <span class="category-label category-label--tips">tips</span>
...
add_action('wp_ajax_loadmore-tips', 'load_more_tips_posts');
add_action('wp_ajax_nopriv_loadmore-tips', 'load_more_tips_posts');
