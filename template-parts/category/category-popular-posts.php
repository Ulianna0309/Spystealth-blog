<section class="popular-posts" data-animation-post-cards>
    <?php
    ...
    if ( $query->have_posts() ) {
        while ( $query->have_posts() ) {
            ...
            <article class="popular-post post-card-animation">
                ...
                if ($imageHero) {
                    echo wp_get_attachment_image($imageHero, 'medium', false, array(
