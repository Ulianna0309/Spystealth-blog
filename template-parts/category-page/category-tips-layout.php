<section class="articles articles-tips articles--bg-blue" data-animation-post-cards>
    <?php
    ...
    if ( $query->have_posts() ) {
        while ( $query->have_posts() ) {
            ...
            if ($counter == 2 || $counter == 4 || $counter == 5 || $counter == 7 || $counter == 9 || $counter == 10) {
            ...
            ?>
            <article class="article post-card-animation article-tips<?= $article_class; ?>">
                <?php
                ...
                <div class="article__content<?= $article_content_class; ?>">
                    <div class="article__header">
                        <span class="category-label category-label--tips category-label--no-changes">tips</span>
